(function (window, document) {
    var SliderBar = function (dom,options) {
        // 判断是用函数创建的还是用new创建的。这样我们就可以通过MaskShare("dom") 或 new MaskShare("dom")来使用这个插件了
        if (!(this instanceof SliderBar)) return new SliderBar(dom,options);
        // 参数
        ...
        if (dataList.length > 0) {
            var html = "<div class='slide-box'><div class='slide-img-block'>" +
                ...
                "<div class='scroll-background scroll-bar' id='scroll'>" +
            ...
            let obj2 = document.getElementsByClassName("slide-img-block");
            obj.onmousedown = function () {
                obj2[0].style.zIndex = '2';
            ...
            obj.onmouseleave = function () {
                setTimeout(function () {
                    obj2[0].style.zIndex = '0';
                    obj2[0].style.opacity = '0';
                },2000)
            }
        }
        this.init();
    ...
    SliderBar.prototype = {
        ...
        reToNewImg: function () {
            ...
            var imgSrc = "/sliderImages/" + _this.imgList[index] + "";
